      ...
      <section className="container mx-auto px-4 py-20 min-h-[calc(100vh-80px)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            ...
            <p className="mb-4">
              I've also had the opportunity to work as a freelancer on platforms like <strong>Fiverr</strong> and <strong>Upwork</strong>, building custom solutions for clients globally.
              These experiences have strengthened my adaptability and problem-solving skills while expanding my exposure to international standards.
            </p>
            <p className="mb-4">
              Living in Cyprus, I led the development of projects like <strong>Online Traffic King</strong>—a digital platform to streamline online traffic awareness—and <strong>OigioCafe</strong>, 
              a modern café experience with a fully integrated digital ordering system.
            </p>
            <p>
          ...
          <div className="order-1 md:order-2 perspective">
            <div className="relative h-[400px] w-full rounded-2xl overflow-hidden shadow-xl card-3d">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MXwxfDB8MXxhbGx8fHx8fHx8&ixlib=rb-1.2.1&q=80&w=1080&utm_source=unsplash_source&utm_medium=referral&utm_campaign=api-credit')",
                }}
              ></div>
            </div>
          </div>
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <Card
                key={index}
                className="bg-secondary border-none hover:shadow-lg transition-shadow duration-300"
              >
