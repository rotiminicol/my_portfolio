  ...
  return (
    <Layout>
      <section className="container mx-auto px-4 py-10 md:py-20 min-h-[calc(100vh-80px)]">
        <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold mb-8 md:mb-12 text-center gradient-text">
          About Me
        </h1>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="order-2 md:order-1">
            <h2 className="text-xl md:text-2xl font-bold mb-4">My Journey</h2>
            ...
            <div className="grid grid-cols-2 gap-4 mt-6 md:mt-8">
              {aboutStats.map((stat, index) => (
                <div key={index} className="text-center p-3 md:p-4 bg-secondary/30 rounded-lg">
                  <h3 className="text-2xl md:text-3xl font-bold gradient-text">{stat.number}+</h3>
          ...
          <div className="order-1 md:order-2 perspective mb-8 md:mb-0">
            <div className="relative h-[250px] md:h-[350px] lg:h-[400px] w-full rounded-2xl overflow-hidden shadow-xl card-3d">
        ...
        <div className="mt-10 md:mt-20">
          <h2 className="text-xl md:text-2xl font-bold mb-6 md:mb-8 text-center">Personal Values</h2>
            ...
            {[
              ...
              <Card key={index} className="bg-secondary border-none hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3 gradient-text">{value.title}</h3>
        ...
        <div className="mt-10 md:mt-20">
          <h2 className="text-xl md:text-2xl font-bold mb-6 md:mb-8 text-center">My GitHub</h2>
          <div className="flex justify-center">
            <a 
              href="https://github.com/rotiminicol" 
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 md:px-6 py-3 bg-secondary rounded-lg hover:bg-secondary/70 transition-colors"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-github">
                <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"></path>
                <path d="M9 18c-4.51 2-5-2-7-2"></path>
              </svg>
              <span className="text-sm md:text-base">github.com/rotiminicol</span>
            </a>
          </div>
        </div>
      </section>
